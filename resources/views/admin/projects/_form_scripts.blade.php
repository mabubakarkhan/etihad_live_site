...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('gallery-existing-list')?.addEventListener('click', function(e) {
        if (e.target.classList.contains('remove-gallery-item')) {
            var row = e.target.closest('.gallery-item-row');
            if (!row) return;
            var path = row.getAttribute('data-path');
            var container = document.getElementById('gallery-remove-container');
            if (path && container) {
