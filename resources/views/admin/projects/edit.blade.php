        ...
        <div class="min-h-screen flex">
            ...
            <main class="flex-1 bg-gradient-to-br from-slate-100 via-slate-50 to-slate-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 overflow-auto transition-colors">
                <header class="px-8 pt-6 pb-4 border-b border-slate-200 dark:border-slate-800/70 flex items-center justify-between sticky top-0 bg-slate-100/95 dark:bg-slate-950/95 z-10 flex-wrap gap-3">
                    <div>
                        <h1 class="text-xl md:text-2xl font-semibold tracking-tight text-slate-900 dark:text-slate-50">Edit project</h1>
                ...
                <section class="px-6 md:px-8 py-6 md:py-8">
                    ...
                    <form method="POST" action="{{ route('admin.projects.update', $project) }}" id="project-form"
                        ...
                        <div class="mb-6 flex flex-wrap items-center gap-3">
                            <button type="submit" class="inline-flex items-center justify-center rounded-lg bg-emerald-500 px-6 py-2.5 text-sm font-semibold text-slate-950 shadow shadow-emerald-500/40 hover:bg-emerald-400 transition">Update project</button>
                        ...
                        @include('admin.projects._form_sections', ['project' => $project, 'projectTypes' => $projectTypes, 'states' => $states])
                    </form>
                </section>
            </main>
        </div>
