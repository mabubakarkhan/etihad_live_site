        ...
        <section class="popular-listings popular-listings--dealers">
          <div class="popular-listings__inner">
            <div class="popular-listings__intro">
              <div class="popular-listings__eyebrow">{{ $setting->eyebrow }}</div>
              <div class="popular-listings__heading-row">
                <div>
                  <h2 class="popular-listings__heading">{{ $setting->title_line_1 }} <span>{{ $setting->title_highlight }}</span></h2>
                ...
                <div class="popular-listings__controls">
                  ...
                  <a href="{{ route('team') }}" class="popular-listings__view-all">{{ $setting->view_all_label }}</a>
                </div>
              </div>
            </div>
...
@endforeach
            ...
            <div class="popular-listings__footer">
              <div class="popular-listings__note">{{ $setting->footer_note }}</div>
