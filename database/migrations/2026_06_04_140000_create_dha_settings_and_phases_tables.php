...
return new class extends Migration
{
    ...
    {
        migration_create_table('dha_settings', function (Blueprint $table) {
            $table->id();
        ...
        migration_create_table('dha_phases', function (Blueprint $table) {
            $table->id();
            $table->string('title');
        ...
        migration_create_table('dha_phase_project_type', function (Blueprint $table) {
            $table->id();
        ...
        migration_seed_if_empty('dha_settings', function () {
        ...
        migration_seed_if_empty('dha_phases', function () {
            $now = now();
            for ($i = 1; $i <= 11; $i++) {
