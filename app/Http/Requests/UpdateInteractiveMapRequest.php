...
class UpdateInteractiveMapRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'overlay_path' => ['nullable', 'array', 'min:3'],
            'overlay_path.*.lat' => ['required_with:overlay_path', 'numeric', 'between:-90,90'],
            'overlay_path.*.lng' => ['required_with:overlay_path', 'numeric', 'between:-180,180'],
