(function () {
    var modal = document.getElementById('dha-phase-bulk-media-modal');
    if (!modal) return;

    var subtitle = document.getElementById('dha-phase-bulk-media-subtitle');
    var zipInput = document.getElementById('dha-phase-bulk-media-zip');
    var statusEl = document.getElementById('dha-phase-bulk-media-status');
    var previewWrap = document.getElementById('dha-phase-bulk-media-preview');
    var previewList = document.getElementById('dha-phase-bulk-media-preview-list');
    var warningsEl = document.getElementById('dha-phase-bulk-media-warnings');
    var resultEl = document.getElementById('dha-phase-bulk-media-result');
    var uploadBtn = document.getElementById('dha-phase-bulk-media-upload-btn');
    var importBtn = document.getElementById('dha-phase-bulk-media-import-btn');
    ...
    function openModal(btn) {
        state.phaseId = btn.getAttribute('data-phase-id');
        state.previewUrl = btn.getAttribute('data-preview-url');
        state.importUrl = btn.getAttribute('data-import-url');
        if (subtitle) {
            subtitle.textContent = 'Phase: ' + (btn.getAttribute('data-phase-title') || '');
        }
        resetModal();
    ...
    document.querySelectorAll('.dha-phase-bulk-media-open').forEach(function (btn) {
        btn.addEventListener('click', function () { openModal(btn); });
    });

    modal.querySelectorAll('.dha-phase-bulk-media-close, .dha-phase-bulk-media-backdrop').forEach(function (el) {
