(function (window) {
    ...
    DrawingManager.prototype.updateRectangle = function (latLng) {
        ...
        var rectOpts = this.shapeOptions();
        this.rectPreview_ = new g.Rectangle({
            bounds: bounds,
            map: this.map,
            clickable: false,
            fillColor: rectOpts.fillColor,
            strokeColor: rectOpts.strokeColor,
            fillOpacity: rectOpts.fillOpacity,
            strokeOpacity: rectOpts.strokeOpacity,
            strokeWeight: rectOpts.strokeWeight,
            editable: false,
            draggable: false,
        });
